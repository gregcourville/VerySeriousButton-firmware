		...
		case VSB_CMD_FUCKYOU:;
			switch(vsbStatus.slurIndex++) {
				case 0:
					...
					break;
				case 1:
					sprintf((char *)vsbStatus.respData, "CUNT");
					break;
				case 2:
					sprintf((char *)vsbStatus.respData, "BITCHWHORE");
					break;
				case 3:
					sprintf((char *)vsbStatus.respData, "COCKSUCKER");
					break;
				case 4:
					sprintf((char *)vsbStatus.respData, "[n-word]");
					break;
				default:
					sprintf((char *)vsbStatus.respData, "[(n+%d)-word]", vsbStatus.slurIndex-5);
				}
			vsbStatus.respId = VSB_RESP_OK;
			break;
